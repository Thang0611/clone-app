...
**Email trong .env.local:** `khoahocgiare.info@gmail.com`

Test với script:
```bash
cd /root/project/clone-app
node scripts/test-login.js khoahocgiare.info@gmail.com "your-password"
```
...
2. Nhập **exact email**: `khoahocgiare.info@gmail.com`
...
**Solution:**
- Sử dụng **exact email**: `khoahocgiare.info@gmail.com`
...
- [ ] Test với exact email: `khoahocgiare.info@gmail.com`
