...
**Hiện tại:**
```typescript
const response = await fetch("https://api.getcourses.net/api/payment/create-order", {
```
...
```typescript
const response = await fetch("https://api.getcourses.net/api/v1/payment/create-order", {
```
