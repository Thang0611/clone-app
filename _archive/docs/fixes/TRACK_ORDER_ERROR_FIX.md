...
```
Look for:
- `Calling API: https://api.getcourses.net/...`
- `Response status: 200`
...
**CORS Error:**
```
Access to fetch at 'https://api.getcourses.net/...' 
from origin 'https://getcourses.net' has been blocked by CORS policy
```
**Fix:** Add CORS headers in backend:
```javascript
res.setHeader('Access-Control-Allow-Origin', 'https://getcourses.net');
...
4. **Verify backend:**
```bash
curl "https://api.getcourses.net/api/v1/payment/lookup?email=test@example.com"
```

5. **Test on production:**
- Go to https://getcourses.net/track-order
- Enter test email
