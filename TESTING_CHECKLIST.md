...
**Frontend:** https://khoahocgiare.info  
**Backend API:** https://api.khoahocgiare.info  
**Admin Dashboard:** https://khoahocgiare.info/admin
...
- ✅ PM2 process running: `khoahocgiare-frontend`
...
1. **DNS Configuration:**
   - `khoahocgiare.info` → Your server IP
   - `api.khoahocgiare.info` → Your server IP
...
**Browser Test:**
1. Open: https://khoahocgiare.info/admin
2. Check for:
...
**Steps:**
1. Navigate to https://khoahocgiare.info/admin
...
```bash
pm2 status
# Expected: khoahocgiare-frontend status = online
```
...
│ id │ name                  │ mode │ status   │
├────┼───────────────────────┼──────┼──────────┤
│ 0  │ khoahocgiare-frontend │ cluster │ online   │
└────┴───────────────────────┴──────┴──────────┘
```
...
```bash
pm2 logs khoahocgiare-frontend --lines 20
...
curl -H "Origin: https://example.com" \
     -I https://api.khoahocgiare.info/api/admin/orders
...
```bash
curl -I https://khoahocgiare.info/admin
...
2. Verify CORS allows `khoahocgiare.info`
