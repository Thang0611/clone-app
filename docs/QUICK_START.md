...
**Production URL:** https://khoahocgiare.info/admin  
...
✅ PM2 Process: khoahocgiare-frontend (online)
...
| Service | URL |
|---------|-----|
| **Homepage** | https://khoahocgiare.info |
| **Admin Dashboard** | https://khoahocgiare.info/admin |
| **Backend API** | https://api.khoahocgiare.info |
| **API Orders** | https://api.khoahocgiare.info/api/admin/orders |
| **API Stats** | https://api.khoahocgiare.info/api/admin/stats |
...
│ id │ name                  │ pid     │ status  │
├────┼───────────────────────┼─────────┼─────────┤
│ 0  │ khoahocgiare-frontend │ 81617   │ online  │
└────┴───────────────────────┴─────────┴─────────┘
```
...
```bash
# Frontend proxy
sudo nano /etc/nginx/sites-available/khoahocgiare.info

# Backend proxy
sudo nano /etc/nginx/sites-available/api.khoahocgiare.info
